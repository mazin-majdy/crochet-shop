            ...
            <header class="top-navbar d-flex justify-content-between align-items-center shadow-sm">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown me-2">
                        <a href="#" class="nav-icon-btn" id="msgDropdown" data-bs-toggle="dropdown" data-bs-boundary="viewport" data-bs-display="static" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="msgDropdown">
                            ...
                            <a class="dropdown-item d-flex align-items-start" href="#">
                                <div class="bg-light rounded-circle me-3" style="width: 45px; height: 45px; background-image: url('https://i.pravatar.cc/150?u=1'); background-size: cover;"></div>
                            ...
                            <a class="dropdown-item d-flex align-items-start" href="#">
                                <div class="bg-light rounded-circle me-3" style="width: 45px; height: 45px; background-image: url('https://i.pravatar.cc/150?u=2'); background-size: cover;"></div>
                                <div class="item-content flex-grow-1">
                                    <h6>خالد محمد</h6>
                    ...
                    <div class="dropdown me-2">
                        <a href="#" class="nav-icon-btn" id="notifyDropdown" data-bs-toggle="dropdown" data-bs-boundary="viewport" data-bs-display="static" aria-expanded="false">
